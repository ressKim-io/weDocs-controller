...
| 3 | 타 사용자 커서·선택 실시간 표시 | M3 | 🔶 | 서비스 branch push·review findings 반영 + frontend 84/84·build, backend Docker-free 보안 테스트·compile/Checkstyle/PMD 통과. `/api/users/me` Testcontainers 테스트는 작성했으나 Docker 회귀·4프로세스 2브라우저 스크린샷/로그·PR/merge 대기 |
