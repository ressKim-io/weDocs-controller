...
- 리뷰 피드백을 반영한다
- 크래프트 표준 체크리스트(`error-handling.md`·`concurrency.md`·`layering-readability.md`·`observability.md`)의 **[B] 위반 = 반려** — 수정 후 재리뷰. 새로 잡힌 갭은 해당 표준 체크리스트에 항목으로 승격한다(gap→standard loop 폐쇄)
